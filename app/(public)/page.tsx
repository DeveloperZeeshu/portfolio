    ...
    <main className="mx-auto max-w-7xl px-6 pt-32 pb-20 space-y-32">
      ...
      <section id="work">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          {[1, 2, 3, 4].map((i) => (
            <GlassCard key={i} className="group cursor-pointer transition-all">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-12 border-y border-white/5 py-20">
        <div className="space-y-4">
          <h3 className="text-lg font-bold text-white italic">01. Architecture</h3>
          <p className="text-sm text-zinc-400 leading-relaxed">
            I prioritize modular, maintainable codebases. Using Clean Architecture principles
            to ensure projects are scalable from day one.
          </p>
        </div>
        <div className="space-y-4">
          <h3 className="text-lg font-bold text-white italic">02. Performance</h3>
          <p className="text-sm text-zinc-400 leading-relaxed">
            Speed is a feature. I optimize Core Web Vitals, implement efficient caching
            strategies, and minimize bundle sizes.
          </p>
        </div>
        <div className="space-y-4">
          <h3 className="text-lg font-bold text-white italic">03. Ownership</h3>
          <p className="text-sm text-zinc-400 leading-relaxed">
            Beyond code, I focus on the product goals. I build solutions that solve
            actual business problems, not just technical puzzles.
          </p>
        </div>
      </section>
    </main>
